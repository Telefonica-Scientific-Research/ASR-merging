#!/bin/bash
#SBATCH --job-name=voxtral_nllb150_r32_duallr
#SBATCH --output=./slurm_logs/voxtral_nllb150_r32_duallr_%j.out
#SBATCH --error=./slurm_logs/voxtral_nllb150_r32_duallr_%j.err
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --experiment-name voxtral_mcq_nllb150_r32a64_duallr_chat_tmpl_4gpu \
  --timestamped-exp-dir \
  --prompt-language en \

#!/bin/bash
#SBATCH --job-name=voxtral_v2_original_bs32
#SBATCH --output=./slurm_logs/voxtral_v2_original_bs32_%j.out
#SBATCH --error=./slurm_logs/voxtral_v2_original_bs32_%j.err
...
echo "ASR-merging Voxtral MCQ Train 4-GPU — v2 original | 124-file held-out eval | bs32"
echo "=========================================="
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --experiment-name voxtral_mcq_v2_original_bs32_4gpu \
  --timestamped-exp-dir \
  --prompt-language en \
...
echo 'Voxtral MCQ v2_original bs32 4-GPU training completed successfully'

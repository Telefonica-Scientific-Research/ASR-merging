#!/bin/bash
#SBATCH --job-name=voxtral_mcq_balanced_4gpu
#SBATCH --output=./slurm_logs/voxtral_mcq_balanced_4gpu_%j.out
#SBATCH --error=./slurm_logs/voxtral_mcq_balanced_4gpu_%j.err
...
echo "ASR-merging Voxtral MCQ Train 4-GPU — balanced JSONL"
echo "=========================================="
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --experiment-name voxtral_mcq_balanced_jsonl_4gpu \
  --prompt-language en \

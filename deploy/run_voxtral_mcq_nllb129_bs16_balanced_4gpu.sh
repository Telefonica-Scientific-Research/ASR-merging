#!/bin/bash
#SBATCH --job-name=voc_n129_bs16_bal
#SBATCH --output=./slurm_logs/voc_n129_bs16_bal_%j.out
#SBATCH --error=./slurm_logs/voc_n129_bs16_bal_%j.err
...
echo "ASR-merging Voxtral MCQ Train 4-GPU — NLLB-translated questions (all EN)"
echo "=========================================="
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --experiment-name voxtral_mcq_nllb129_bs16_balanced_4gpu \
  --timestamped-exp-dir \
  --prompt-language en \
...
echo 'Voxtral MCQ NLLB-translated 4-GPU training completed successfully'

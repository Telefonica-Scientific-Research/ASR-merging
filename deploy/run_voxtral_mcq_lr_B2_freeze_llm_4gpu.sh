#!/bin/bash
#SBATCH --job-name=voxtral_mcq_lr_B2
#SBATCH --output=./slurm_logs/voxtral_mcq_lr_B2_%j.out
#SBATCH --error=./slurm_logs/voxtral_mcq_lr_B2_%j.err
...
echo "ASR-merging Voxtral MCQ LR B2 freeze-llm 4-GPU"
echo "=========================================="
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --experiment-name voxtral_mcq_lr_B2_freeze_llm \
  --prompt-language en \

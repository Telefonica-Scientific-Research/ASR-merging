#!/bin/bash
#SBATCH --job-name=voxtral_mcq_r16_a16
#SBATCH --output=./slurm_logs/voxtral_mcq_r16_a16_%j.out
#SBATCH --error=./slurm_logs/voxtral_mcq_r16_a16_%j.err
...
echo "ASR-merging Voxtral MCQ LoRA r=16 alpha=16 4-GPU"
echo "=========================================="
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --experiment-name voxtral_mcq_lora_r16_a16 \
  --prompt-language en \

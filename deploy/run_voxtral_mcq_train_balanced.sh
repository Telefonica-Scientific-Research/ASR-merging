#!/bin/bash
#SBATCH --job-name=voxtral_mcq_balanced
#SBATCH --output=./slurm_logs/voxtral_mcq_balanced_%j.out
#SBATCH --error=./slurm_logs/voxtral_mcq_balanced_%j.err
...
echo "ASR-merging Voxtral MCQ Train — balanced JSONL"
echo "=========================================="
...
python -m asr_merging.voxtral_train_MCQ \
  ...
  --experiment-name voxtral_mcq_balanced_jsonl \
  --prompt-language en \
...
echo 'Voxtral MCQ balanced training completed successfully'

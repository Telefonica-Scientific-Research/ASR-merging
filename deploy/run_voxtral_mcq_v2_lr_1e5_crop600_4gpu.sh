#!/bin/bash
#SBATCH --job-name=voxtral_v2c_lr_1e5
#SBATCH --output=./slurm_logs/voxtral_v2_lr_1e5_crop600_%j.out
#SBATCH --error=./slurm_logs/voxtral_v2_lr_1e5_crop600_%j.err
...
echo "ASR-merging Voxtral MCQ Train 4-GPU — v2 mixed | lr=1e-5 | all components"
echo "=========================================="
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --experiment-name voxtral_mcq_v2_mixed_lr_1e5_crop600_4gpu \
  --timestamped-exp-dir \
  --prompt-language en \
...
echo 'Voxtral MCQ voxtral_mcq_v2_mixed_lr_1e5_4gpu crop600 completed successfully'

#!/bin/bash
#SBATCH --job-name=voxtral_mcq_lr_B1
#SBATCH --output=./slurm_logs/voxtral_mcq_lr_B1_%j.out
#SBATCH --error=./slurm_logs/voxtral_mcq_lr_B1_%j.err
...
echo "ASR-merging Voxtral MCQ LR B1 freeze-encoder-connector 4-GPU"
echo "=========================================="
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --experiment-name voxtral_mcq_lr_B1_freeze_enc \
  --prompt-language en \

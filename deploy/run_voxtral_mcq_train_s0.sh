#!/bin/bash
#SBATCH --job-name=voxtral_mcq_s0
#SBATCH --output=./slurm_logs/voxtral_mcq_s0_%j.out
#SBATCH --error=./slurm_logs/voxtral_mcq_s0_%j.err
...
echo "ASR-merging Voxtral MCQ Train (shard 0)"
echo "=========================================="
...
python -m asr_merging.voxtral_train_MCQ \
  ...
  --experiment-name voxtral_mcq_original_cache_s0_replicate \
  --prompt-language en \
...
echo 'Voxtral MCQ training completed successfully'

#!/bin/bash
#SBATCH --job-name=voxtral_nllb_trx_4gpu
#SBATCH --output=./slurm_logs/voxtral_nllb_trx_4gpu_%j.out
#SBATCH --error=./slurm_logs/voxtral_nllb_trx_4gpu_%j.err
...
echo "ASR-merging Voxtral MCQ Train 4-GPU — R6-base + transcript (NLLB-translated)"
echo "=========================================="
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --experiment-name voxtral_mcq_nllb_transcript_4gpu \
  --timestamped-exp-dir \
  --prompt-language en \

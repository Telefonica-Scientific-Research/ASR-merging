#!/bin/bash
#SBATCH --job-name=voc_n150_bs16_bal
#SBATCH --output=./slurm_logs/voc_n150_bs16_bal_%j.out
#SBATCH --error=./slurm_logs/voc_n150_bs16_bal_%j.err
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --experiment-name voxtral_mcq_nllb150_bs16_balanced_4gpu \
  --timestamped-exp-dir \
  --prompt-language en \

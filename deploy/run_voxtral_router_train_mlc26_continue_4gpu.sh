#!/bin/bash
#SBATCH --job-name=voxtral_router_mlc26_continue_4gpu
#SBATCH --output=./slurm_logs/voxtral_router_mlc26_continue_4gpu_%j.out
#SBATCH --error=./slurm_logs/voxtral_router_mlc26_continue_4gpu_%j.err
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --config-json configuration/mlc26_train_eval_continue_from_current_4gpu_fixed_bothsides.json

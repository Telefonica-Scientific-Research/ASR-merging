#!/bin/bash
#SBATCH --job-name=voxtral_fz_l1_bal12_4g
#SBATCH --output=./slurm_logs/voxtral_fz_l1_bal12_4g_%j.out
#SBATCH --error=./slurm_logs/voxtral_fz_l1_bal12_4g_%j.err
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --experiment-name voxtral_mcq_nllb_icl_crop30_frzenc_lr1e5_bal_12ep_4gpu \
  --balance-by-language \
  ...
  --resume-from-checkpoint /opt/ASR-merging/experiments/voxtral_mcq_nllb_icl_crop30_frzenc_lr1e5_bal_4gpu_20260628_004749/checkpoint-150 \
  2>&1

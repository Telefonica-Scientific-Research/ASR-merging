#!/bin/bash
#SBATCH --job-name=voxtral_router_mlc26_full_train_cont_4gpu
#SBATCH --output=./slurm_logs/voxtral_router_mlc26_full_train_cont_4gpu_%j.out
#SBATCH --error=./slurm_logs/voxtral_router_mlc26_full_train_cont_4gpu_%j.err
...
echo "ASR-merging Voxtral Router Train/Eval"
echo "=========================================="
...
torchrun --standalone --nproc_per_node=4 --master_port \${MASTER_PORT} \
  ...
  --config-json configuration/mlc26_train_eval_full_train_continuation_4gpu_fixed_bothsides.json

echo 'Voxtral router train/eval completed successfully'
